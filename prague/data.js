window.PRAGUE_DATA = {
  ...
  places: [
    ...
    { id:"ymca-paternoster", name:"Palác YMCA Paternoster Lift", zh:"不停站循環升降機", days:[2], category:"sight", area:"Republic Square／New Town", lat:50.08910, lng:14.43114, time:"Cafe Imperial 後", duration:"15–20 分鐘", priority:"special", image:"ymca_paternoster.webp", description:"Na Poříčí 12，順路由 Cafe Imperial 行過去。1928 年建成的循環式升降機，有 16 個開放車廂不停運行、服務 7 層；位置在 reception 後方。運作及訪客安排可能改變，先問職員；長者、小朋友或行動不便者建議只觀看，切勿搭車廂繞過頂層或底層。" },
    ...
    { id:"wenceslas", name:"Wenceslas Square", zh:"瓦茨拉夫廣場", days:[2,4], category:"sight", area:"New Town", lat:50.08113, lng:14.42549, time:"18:30／Day 4 補買", timeByDay:{2:"18:30",4:"09:15"}, duration:"45–90 分鐘", image:"wenceslas_night.webp", description:"商業大道、夜間街景及最後補買區域。" },
    ...
    { id:"starbucks-castle", name:"Starbucks Prague Castle", zh:"城堡景觀位", days:[3], category:"food", area:"Hradčany", lat:50.08987, lng:14.39716, time:"09:00", duration:"15–30 分鐘", image:"starbucks_castle.webp", description:"咖啡是 bonus，露台望向布拉格市區的高位景觀才是主角。" },
    ...
    { id:"mash-hana", name:"Mash Hana", zh:"正宗日式午餐", days:[3], category:"food", area:"Hradčany／Praha 6", lat:50.09722, lng:14.40751, time:"11:30", duration:"60 分鐘", image:"mash_hana_sushi.webp", description:"Badeniho 3 的日式餐廳，主打壽司、刺身及傳統和食。星期五有午餐時段，故安排 Day 3；食完再落 Malá Strana。" },
    { id:"local-artists", name:"LOCAL ARTISTS", zh:"本地創作者手信店", days:[3], category:"shopping", area:"Malá Strana", lat:50.08710, lng:14.40389, time:"下午", duration:"20–30 分鐘", image:"local_artists_store.webp", description:"Karmelitská 26 的兩層 gift shop。可留意 Prague 插畫、小版畫、明信片、首飾及小型手作；庫存隨創作者改變。", souvenir:true },
    ...
    { id:"alley", name:"Prague’s Narrowest Alley", zh:"有交通燈的最窄小巷", days:[3], category:"sight", area:"Malá Strana", lat:50.08794, lng:14.40909, time:"下午", duration:"5–10 分鐘", image:"narrowest_alley.webp", imagePosition:"50% 22%", description:"窄巷設有行人交通燈；適合順路看，不值得專程跨區。" },
    ...
    { id:"porks", name:"Pork’s Mostecká", zh:"捷克豬肉料理", days:[3], category:"food", area:"Malá Strana", lat:50.08749, lng:14.40605, time:"Early dinner 候補", duration:"45–75 分鐘", image:"porks_knuckle.webp", description:"近 Charles Bridge 西岸橋頭；招牌是脆皮豬手。Mash Hana 食得少可 early dinner，否則飲杯嘢便走。" },
    ...
    { id:"day4-shopping", name:"Na Příkopě Shopping Walk", zh:"最後補買路線", days:[4], category:"shopping", area:"Old Town／New Town", lat:50.08489, lng:14.42574, time:"08:30–10:15", duration:"約 90 分鐘", image:"na_prikope.webp", description:"Old Town Square → Havel Market → Na Příkopě → Wenceslas。10:15 返回酒店。" }
  ],
  souvenirs: [
    ...
    { id:"local-artists", name:"LOCAL ARTISTS", type:"本地創作者作品", image:"local_artists_store.webp", intro:"集合捷克創作者作品，產品及庫存會隨藝術家變動。", signature:["Prague 小版畫／插畫","明信片與紙品","小型首飾／手作"], forWhom:"鍾意獨特、藝術感的人", tip:"優先買有作者名、細件及真正喜歡的作品。", official:"https://www.localartists.cz/en/our-stores" },
